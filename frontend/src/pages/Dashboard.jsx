  ...
  return (
    <div>
        ...
        <main className=' h-fit w-full p-6 flex justify-center items-center flex-wrap '>
            ...
            <div onClick={() => { navigate('/videochatrandom')}} className=' w-4/5 md:w-3/5 lg:w-2/5 h-fit py-20 px-4 m-4 flex justify-center items-center text-xl md:text-2xl lg:text-3xl cursor-pointer hover:border-4 hover-scale-1.4 hover:border-purple-700 bg-purple-300 rounded-sm md:rounded-lg lg:rounded-3xl'>video chat random</div>
            <div onClick={() => { navigate('/videochatspecific')}} className=' w-4/5 md:w-3/5 lg:w-2/5 h-fit py-20 px-4 m-4 flex justify-center items-center text-xl md:text-2xl lg:text-3xl cursor-pointer hover:border-4 hover-scale-1.4 hover:border-emerald-700 bg-emerald-300 rounded-sm md:rounded-lg lg:rounded-3xl'>video chat specific</div>
            <div onClick={() => { navigate('/videochatmultiple')}} className=' w-4/5 md:w-3/5 lg:w-2/5 h-fit py-20 px-4 m-4 flex justify-center items-center text-xl md:text-2xl lg:text-3xl cursor-pointer hover:border-4 hover-scale-1.4 hover:border-orange-700 bg-orange-300 rounded-sm md:rounded-lg lg:rounded-3xl'>video chat multiple</div>
